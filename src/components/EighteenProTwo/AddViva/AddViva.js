                ...
                <div className="" style={{ width: '100%', backgroundColor: '#13131A'}}>
                    <div className={classes.root}>
                        <Accordion style={{background: '#23232D', color: 'white'}}>
                            ...
                            id="panel1a-header"
                            >
                            <Typography className={classes.heading}>Add Board Viva Mark<FontAwesomeIcon style={{ color: '#FF3768'}} className='ml-2' icon={faArrowRight} /></Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                            <Typography>
                    ...
                    <div className="add-ct px-5 pb-5 d-flex justify-content-center">
                        ...
                        <form className='text-white' style={{height: '400px', width: '500px'}}>
